/* Create-script voor GrootOrderdatabaseKS
   (met kunstmatige sleutels)
...
create domain Orderregelnr              as integer;
...
alter table Klant
add constraint fk_aanbrenger_van_klant 
...
(nr               Orderregelnr not null,
 order_           Ordernr      not null,
 volgnr           Volgnr       not null,
 artikel          Artikelnr    not null,
 aantal           Aantal       not null,
 bedrag           Geldbedrag,
 constraint pk_orderregel primary key (nr),
 constraint un_orderregel_volgnr unique (order_, volgnr), 
 constraint un_orderregel_artikel unique (order_, artikel),
